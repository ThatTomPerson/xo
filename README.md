...
```sh
$ go get -u github.com/thattomperson/zen

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/thattomperson/zen
```
...
$ cp "$GOPATH/src/github.com/thattomperson/zen/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/thattomperson/zen/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/thattomperson/zen
```
